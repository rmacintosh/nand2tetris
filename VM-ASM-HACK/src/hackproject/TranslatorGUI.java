...
public class TranslatorGUI extends javax.swing.JFrame {
    ...
    public TranslatorGUI() {
        ...
        vmCodeLength.setText("0 Lines");
        asmCodeLength.setText("0 Lines");
        hackCodeLength.setText("0 Lines");
    }
    ...
    private void initComponents() {
        ...
        vmCodeLength = new javax.swing.JLabel();
        asmCodeLength = new javax.swing.JLabel();
        hackCodeLength = new javax.swing.JLabel();
        ...
        translatorToolBar.setBorder(javax.swing.BorderFactory.createBevelBorder(0));
        ...
        vmCodeLength.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        vmCodeLength.setForeground(new java.awt.Color(0, 102, 0));
        vmCodeLength.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        asmCodeLength.setBackground(javax.swing.UIManager.getDefaults().getColor("tab_focus_fill_dark_lower"));
        asmCodeLength.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        asmCodeLength.setForeground(new java.awt.Color(0, 102, 0));
        asmCodeLength.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        hackCodeLength.setBackground(javax.swing.UIManager.getDefaults().getColor("tab_focus_fill_dark_lower"));
        hackCodeLength.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        hackCodeLength.setForeground(new java.awt.Color(0, 102, 0));
        hackCodeLength.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(translatorToolBar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(vmCodeScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(vmCodeLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(vmCodeLength, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addGap(15, 15, 15)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(asmCodeScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(asmCodeLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(asmCodeLength, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addGap(15, 15, 15)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(hackCodeLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(hackCodeLength, javax.swing.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(translatorToolBar, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(vmCodeLength, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(asmCodeLength, javax.swing.GroupLayout.DEFAULT_SIZE, 22, Short.MAX_VALUE)
                        .addComponent(hackCodeLength, javax.swing.GroupLayout.DEFAULT_SIZE, 22, Short.MAX_VALUE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void loadItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadItemActionPerformed
        ...
        if (hackFileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {  // Proceed if we selected a file and clicked 'ok'
            ...
            if(vmFiles.length > 1) {                                                // Selected multiple files
                ...
                vmCodeTextArea.setText("***ERROR***\r\nDirectory has nothing to translate!!\r\n");
                skip = true;
            }
            if(!skip) {
    ...
    private void vmCodeTextAreaCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_vmCodeTextAreaCaretUpdate
        ...
        vmCodeLength.setText(getLines(vmCodeTextArea) + " Lines");
    ...
    private void asmCodeTextAreaCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_asmCodeTextAreaCaretUpdate
        ...
        asmCodeLength.setText(getLines(asmCodeTextArea) + " Lines");
    ...
    private void hackCodeTextAreaCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_hackCodeTextAreaCaretUpdate
        ...
        hackCodeLength.setText(getLines(hackCodeTextArea) + " Lines");
    ...
    private javax.swing.JLabel asmCodeLength;
    ...
    private javax.swing.JLabel hackCodeLength;
    ...
    private javax.swing.JLabel vmCodeLength;
